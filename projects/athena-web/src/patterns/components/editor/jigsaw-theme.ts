...
export const jigsawTheme = createTheme({
  ...
  styles: [
    ...
    { tag: t.heading1, color: colourPalette.whiteGrey["50"], class: "font-bold text-3xl"},
    { tag: t.heading2, color: colourPalette.whiteGrey["50"], class: "font-bold text-2xl"},
    { tag: t.heading3, color: colourPalette.whiteGrey["50"], class: "font-bold text-xl"},
    { tag: t.heading4, color: colourPalette.whiteGrey["50"], class: "font-bold text-lg"},
    { tag: t.heading5, color: colourPalette.whiteGrey["50"], class: "font-bold text-lg"},
    { tag: t.heading6, color: colourPalette.whiteGrey["50"], class: "font-bold text-lg"},
