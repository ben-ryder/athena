    ...
    <>
      ...
      <JContentSection>
        <JProse>
          ...
          <h2>Other</h2>
          <ul>
            <li><Link to={routes.external.github} target="_blank">Project GitHub</Link></li>
            <li><Link to={routes.external.docs} target="_blank">Help & Documentation</Link></li>
            <li><Link to={routes.external.creator} target="_blank">benryder.me</Link></li>
          </ul>
        </JProse>
      </JContentSection>
    </>
