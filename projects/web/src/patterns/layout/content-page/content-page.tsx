...
export function ContentPage(props: PropsWithChildren) {
  return (
    <JContentSection>
      <div className="ath-content-page">{props.children}</div>
    </JContentSection>
  );
}
...
export function ContentPageContent(props: PropsWithChildren) {
  return <div className="ath-content-page__content">{props.children}</div>;
}
...
export function ContentPageField(props: ContentPageFieldProps) {
  const className = classNames("ath-content-page__field", {
