...
export const themeOptions = {
  ...
  settings: {
    ...
    gutterBackground: '#1b1f26',
    gutterForeground: '#5e6878',
    gutterBorder: '#5e6878',
    gutterActiveForeground: '',
    lineHighlight: '#1b1f26',
  },
  styles: [
    ...
    { tag: t.heading1, color: '#eeeeee', class: 'h1' },
    { tag: t.heading2, color: '#eeeeee', class: 'h2' },
    { tag: t.heading3, color: '#eeeeee', class: 'h3' },
    { tag: t.heading4, color: '#eeeeee', class: 'h4' },
    { tag: t.heading5, color: '#eeeeee', class: 'h5' },
    { tag: t.heading6, color: '#eeeeee', class: 'h6' },
